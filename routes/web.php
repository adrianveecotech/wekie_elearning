...
Route::middleware(['web'])->group(function () {
    ...
    Route::middleware(['is_active', 'auth'])->group(function () {
        ...
        Route::middleware(['is_admin'])->group(function () {
            ...
            Route::post('class/{id}/addcoursevideoquiz','CourseVideoQuizController@post')->name('add.coursevideoquiz');
            Route::post('class/{id}/editcoursevideoquiz','CourseVideoQuizController@update')->name('edit.coursevideoquiz');
            Route::post('class/{id}/deletecoursevideoquiz','CourseVideoQuizController@delete');
        ...
        Route::middleware(['admin_instructor'])->group(function () {
            ...
            Route::resource('quiztopic', 'QuizTopicController');
            Route::resource('questions', 'QuizController');
    ...
    Route::middleware(['is_verified'])->group(function () {
        ...
        Route::post('payvia/rave/payment', 'RaveController@success')->name('rave.pay');
        Route::get('/payvia/rave/success', 'RaveController@success')->name('callback');
