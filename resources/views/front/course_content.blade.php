        ...
        <div class="about-block">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link text-center" id="nav-material-tab" data-toggle="tab" href="#nav-material" role="tab" aria-controls="nav-material" aria-selected="false">{{ __('frontstaticword.Material') }}</a>
                    ...
                    <div class="profile-block">                       
                        <div id="accordion" class="second-accordion">
                            ...
                            <div class="card btm-10">
                                <div class="card-header" id="headingChapter{{ $coursechapter->id }}">
                                    <div class="mb-0">
                                        <button type="button" class="btn btn-link" data-toggle="collapse" data-target="#collapseChapters{{ $coursechapter->id }}" aria-expanded="true" aria-controls="collapseChapters">
                                            <div class="course-check-table">
                                            <table class="table">  
                                                <tbody>
                                                    <tr>
                                ...
                                <div id="collapseChapters{{ $coursechapter->id }}" class="collapse" aria-labelledby="headingChapter" data-parent="#accordion">

                                    @php
                                        $classes = App\CourseClass::where('coursechapter_id', $coursechapter->id)->orderBy('position','ASC')->get();
                                        $mytime = Carbon\Carbon::now();
                                    @endphp
                                    @foreach(explode(",",$coursechapter->file) as $file)
                                    @if($coursechapter->status == 1)
                                    <div class="card-body">
                                        <table class="table">  
                                            <tbody>
                                                <tr>
                                                    <td class="class-name">
                                                    <a href="{{ asset('files/material/'.$file) }}" download="{{$file}}" title="Learning Material"><i class="fa fa-download"></i>  {{$file}}</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
