        ...
        <div class="box-body">
          <div class="form-group">
            <form action="{{url('course/')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                  ...
                  <option value="0">{{ __('adminstaticword.SelectanOption') }}</option>
                    @foreach($childcategory as $childcate)
                      <option value="{{$childcate->id}}">{{$childcate->title}}</option>
                    @endforeach
                  </select>
                </div>
                <div class="col-md-3">
              ...
              <div class="row">
                <div class="col-md-12"> 
                  <label>{{ __('adminstaticword.Language') }}: </label>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <textarea name="requirement" rows="3"  class="form-control" placeholder="Enter Requirements" ></textarea>
                </div>
              </div>           
              <br> 
             ...
             <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input min="1" max="100" class="form-control" name="instructor_revenue" type="number" id="revenue"  placeholder="Enter revenue percentage" class="{{ $errors->has('instructor_revenue') ? ' is-invalid' : '' }} form-control">
