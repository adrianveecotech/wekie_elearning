                ...
                <td>
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      <li><a href="{{url('quiztopic/'.$topic->id)}}">Edit</a></li>
                      ...
                      <li class="divider"></li>
                      <li>
                        <form method="post" action="{{url('admin/quiztopic/'.$topic->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                          {{ csrf_field() }}
                          {{ method_field('DELETE') }}
