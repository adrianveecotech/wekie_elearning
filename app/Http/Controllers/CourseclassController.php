...
class CourseclassController extends Controller
{
    ...
    {
        $course_video_quiz = CourseVideoQuiz::where('courseclass_id',$id)->get();
        ...
        return view('admin.course.courseclass.edit',compact('cate','coursechapt','subtitles', 'live_date','course_video_quiz')); 
