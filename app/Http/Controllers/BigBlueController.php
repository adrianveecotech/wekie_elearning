...
class BigBlueController extends Controller
{
    ...
    public function store(Request $request){
    	...
    	return redirect()->route('bbl.all.meeting')->with('success','Meeting created successfully !');
    }
    ...
    public function update(Request $request,$id){
    	...
    	return redirect()->route('bbl.all.meeting')->with('success','Meeting updated successfully !');
    }
    ...
    public function delete($meetingid){
    	...
    	if(isset($meeting)){
    		$meeting->delete();
    		return back()->with('deleted','Meeting deleted successfully !');
    	}else{
